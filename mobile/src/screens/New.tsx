    ...
    <View className="flex-1 bg-background px-8 pt-16">
      <ScrollView
        ...
        <TextInput
          ...
          className="h-12 pl-4 rounded-lg mt-3 bg-zinc-900 text-white border-zinc-800 border-2 focus:border-2 focus:border-green-600"
        ...
        <TouchableOpacity
          ...
          <Text
            className="font-semibold text-base text-white m;-2"
          >
            Confirmar
          </Text>
        </TouchableOpacity>
